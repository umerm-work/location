...
import (
	...
	"github.com/fb-investments/location/pkg/grpc"
	"github.com/fb-investments/location/pkg/grpc/pb"
	"github.com/fb-investments/location/pkg/http"
...
var fs = flag.NewFlagSet("location", flag.ExitOnError)
var debugAddr = fs.String("debug.addr", ":8080", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":8081", "HTTP listen address")

//var dgraphGrpcAddr = fs.String("dgraph-grpc-addr", ":9080", "Dgraph gRPC listen address")
var dgraphGrpcAddr = fs.String("dgraph-grpc-addr", "3.226.89.100:9080", "Dgraph gRPC listen address")
...
func Run() {
	...
	db := dgraph.New(dgraphGrpcAddr,logger)
	svc := service.New(getServiceMiddleware(logger), db, logger)
